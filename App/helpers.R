...
# define full sample repo
full_sample_repo <- "mjfrigaard/SEG_shiny/master/Data/VanderbiltComplete.csv"

# 0.1.4 upload AppRiskPairData.csv from github  ---- ---- ---- ----
...
# 0.1.4 load the AppLookUpRiskCat.csv from github  ---- ---- ---- ---- ----
...
# 0.1.4 load the APPSEGBlandAltmanRefVals.csv from github  ---- ---- ----
github_root <- "https://raw.githubusercontent.com/"
...
# 0.1.4 define risk grade look-up table for RiskGradeTable3  ---- ---- ----
...
# 0.1.4 define lkpISORanges look-up table for ISORangeTable5  ---- ---- ----
...
# 1.4 create base_data data frame ---- ---- ---- ---- ---- ---- ---- ----
