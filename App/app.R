  ...
  mainPanel(
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        # values, 2) equal to the REF values, and 3) greater than the REF values.
        # Note that REF values < 21 mg/dL or >600 mg/dL will not be plotted on
        # the SEG. This tab also stratifies the values across eight
