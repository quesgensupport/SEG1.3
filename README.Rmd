---
title: "SEG Shiny Heatmap (phase 1 (version 1.3))"
...
Provide the background documentation and code for the Shiny SEG app. This is currently version 1.5.1. The major changes to this app have been documented below. 
...
- add plain language interpretation of MARD2 table beyond 'models indicate'  
...
```{r 4.4.8_BinomialTest6_CompliantPairs_count}
...
***NOTE*** the call to `dataset <- segTable(dat)` needs to be added to the top of this function to ensure the reactive dataset have been cleaned identically to the `SampMeasData`
